          ...
          <CardContent className="space-y-4 p-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild variant="outline">
                <Link href="/boutique">Retour au catalogue</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
            ...
            <form action={formAction} className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Field label="Reference chantier" htmlFor="siteReference">
                  <Input id="siteReference" name="siteReference" placeholder="CHANTIER-2026-042" />
                </Field>
              </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="text-sm text-muted-foreground">
                  {profile?.company?.payment_terms ? (
                    ...
                    <span>Vous pouvez aussi convertir le panier en demande de devis si besoin.</span>
                  )}
                </div>
        ...
        <div className="space-y-6">
          <Card className="p-0">
            <CardContent className="space-y-4 p-6">
              ...
              <InfoRow label="Logistique" value={pricing.logisticsMode === "manual" ? "A confirmer" : "Estimee"} />
              <InfoRow
              ...
              <InfoRow
                label="Compte"
                value={user ? "Connecte" : "Public non connecte"}
              />
            </CardContent>
          </Card>
          ...
          <Card className="p-0">
            <CardContent className="space-y-4 p-6">
              ...
              <InfoRow
                label="Societe"
                value={defaultCompanyName || "A renseigner"}
              />
              <InfoRow
                label="Remise societe"
                value={
                  companyDiscountRate > 0
                    ? `${companyDiscountRate.toFixed(0)}%`
                    : "Aucune"
                }
              />
              <InfoRow
          ...
          <Card className="border-primary/20 bg-primary/6 p-0">
            <CardContent className="space-y-3 p-6">
              ...
              <p className="text-sm leading-6 text-muted-foreground">
                Pour basculer un panier complexe, une location ou un besoin multisites, la demande
                de devis reste disponible avec les memes references.
              </p>
